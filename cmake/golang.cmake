function(add_go_executable)
    ...
    set(oneValueArgs OUTPUT CGO_CFLAGS CGO_CPPFLAGS CGO_CXXFLAGS CGO_FFLAGS CGO_LDFLAGS PKG_CONFIG)
    ...
    set(CGO_ENV
        GOBUILD_CGO_CFLAGS 
        GOBUILD_CGO_CPPFLAGS 
        GOBUILD_CGO_CXXFLAGS 
        GOBUILD_CGO_FFLAGS 
        GOBUILD_CGO_LDFLAGS
    )
...
if(CMAKE_SOURCE_DIR STREQUAL CMAKE_CURRENT_SOURCE_DIR)
    ...
    string(REPLACE ${CMAKE_SOURCE_DIR}/src/ "" ${result} ${CMAKE_CURRENT_SOURCE_DIR})
endif()
